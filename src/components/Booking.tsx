export function Booking() {
  return (
    <section id="Booking" className="font-custom1 md:mx-14">
      <div className="container mx-auto px-10">
        <div className="booking-content flex items-center justify-center h-auto w-auto relative md:justify-center">
          <div className="booking-content-box bg-white bg-cover bg-center bg-no-repeat shadow-lg rounded-md text-black w-full h-auto px-4 py-6 relative">
            ...
            <form className="box-form grid md:grid-rows-2 gap-5 md:grid md:grid-cols-3">
              ...
              <button className="text-white bg-gradient-to-br from-red-500 to-orange-400 font-semibold rounded-xl px-5 py-2.5 text-center me-2 md:mt-9 hover:bg-gradient-to-br hover:from-red-600 hover:to-orange-500">
                Search
              </button>
            </form>
          </div>
