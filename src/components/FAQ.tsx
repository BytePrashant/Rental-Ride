      ...
      <section id="FAQ" className="font-custom1 py-24 bg-gray-50">
        ...
        >
          <div className="content flex flex-col items-center">
            ...
            <div className="all-questions  flex flex-col">
              <div className="faq-box-1 bg-white shadow-lg text-black cursor-pointer">
                <div
                  id="q1"
                  className="faq-box__question flex items-center justify-between px-10 py-3 text-lg font-medium hover:bg-gradient-to-br from-red-500 to-orange-400 hover:text-white md:w-[800px]"
              ...
              <div className="faq-box-2 bg-white shadow-lg text-black cursor-pointer">
                <div
                  id="q2"
                  className="faq-box__question flex items-center justify-between px-10 py-3 text-lg font-medium hover:bg-gradient-to-br from-red-500 to-orange-400 hover:text-white md:w-[800px]"
              ...
              <div className="faq-box-3 bg-white shadow-lg text-black cursor-pointer">
                <div
                  id="q3"
                  className="faq-box__question flex items-center justify-between px-10 py-3 text-lg font-medium hover:bg-gradient-to-br from-red-500 to-orange-400 hover:text-white  md:w-[800px]"
