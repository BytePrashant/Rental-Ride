    ...
    <>
      <section id="About" className="font-custom1">
        ...
        <div className="container mx-auto px-10">
          <div className="about-main grid grid-rows-1 gap-8 md:flex md:flex-row">
            <img
              className="about-main__img"
              src="./about-main.jpg"
              alt="car-renting"
            />
            <div className="about-main__text flex flex-col text-center md:text-start md:items-start">
              ...
              <div className="about-main__text__icons flex flex-col gap-6">
